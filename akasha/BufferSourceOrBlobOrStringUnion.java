...
@JsType(
    ...
    name = "BufferSourceOrBlobOrStringUnion"
)
public interface BufferSourceOrBlobOrStringUnion {
  @JsOverlay
  @Nonnull
  static BufferSourceOrBlobOrStringUnion of(@Nonnull final BufferSource value) {
    return Js.cast( value );
  }

  @JsOverlay
  @Nonnull
  static BufferSourceOrBlobOrStringUnion of(@Nonnull final Blob value) {
    return Js.cast( value );
  }

  @JsOverlay
  @Nonnull
  static BufferSourceOrBlobOrStringUnion of(@Nonnull final String value) {
    return Js.cast( value );
  }
