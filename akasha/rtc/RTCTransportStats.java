...
public interface RTCTransportStats extends RTCStats {
  ...
  static Builder create(final double timestamp, @RTCStatsType @Nonnull final String type,
      @Nonnull final String id, @RTCDtlsTransportState @Nonnull final String dtlsState) {
    return Js.<Builder>uncheckedCast( JsPropertyMap.of() ).timestamp( timestamp ).type( type ).id( id ).dtlsState( dtlsState );
  }
