...
public interface RTCIceCandidateStats extends RTCStats {
  ...
  static Builder create(final double timestamp, @RTCStatsType @Nonnull final String type,
      @Nonnull final String id, @RTCIceCandidateType @Nonnull final String candidateType,
      @Nonnull final String transportId) {
    return Js.<Builder>uncheckedCast( JsPropertyMap.of() ).timestamp( timestamp ).type( type ).id( id ).candidateType( candidateType ).transportId( transportId );
  }
  ...
  interface Builder extends RTCIceCandidateStats {
    ...
    @JsOverlay
    @Nonnull
    default Builder candidateType(@RTCIceCandidateType @Nonnull final String candidateType) {
