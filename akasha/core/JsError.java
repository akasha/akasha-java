 ...
 * @see <a href="https://tc39.es/ecma262/multipage/fundamental-objects.html#sec-error-objects"># sec-error-objects</a>
 */
...
public class JsError extends JsObject {
   ...
   * @see <a href="https://tc39.es/ecma262/multipage/fundamental-objects.html#sec-error.prototype.message"># sec-error.prototype.message</a>
   */
  @JsProperty(
      name = "message"
  )
   ...
   * @see <a href="https://tc39.es/ecma262/multipage/fundamental-objects.html#sec-error.prototype.name"># sec-error.prototype.name</a>
   */
  @JsProperty(
      name = "name"
  )
