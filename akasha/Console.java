 ...
 * @see <a href="https://console.spec.whatwg.org/#console-namespace"># console-namespace</a>
 */
@JsType(
    isNative = true,
    name = "console",
...
public final class Console {
   ...
   */
  public static native void dir(@DoNotAutobox @Nullable Object item, @Nullable JsObject options);
